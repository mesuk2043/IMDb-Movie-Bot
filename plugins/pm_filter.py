...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/MesukTarikul1000"),
                InlineKeyboardButton("Series ⭕️", url="https://t.me/MesukTarikul1000")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/MesukTarikul1000t'),
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/MesukTarikul1000'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/MesukTarikul1000')
            ],
            [
                InlineKeyboardButton('🎬 MesukTarikul1000 🎬', url=f'https://t.me/MesukTarikul1000')
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/MesukTarikul1000'),
            InlineKeyboardButton('join ⭕️', url='https://t.me/MesukTarikul1000')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/MesukTarikul1000'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/MesukTarikul1000")
    ])
    ...
    if imdb:
        ...
        cap = f"<b>🎬 Title:</b> {search}\n</b>\n<b><a href='https://t.me/MesukTarikul1000'>© TarikulMesuk1000</a></b>\n\n<b>✍️ Note:</b> <s>join @MesukTarikul1000 fore more.</s>"
